...
__declspec(dllexport) void *memcpy_std(void *d, const void* s, size_t n) 
{
...
// use the Streaming Store instruction MOVNTQ.   This write instruction
// bypasses the cache and writes straight to main memory.  This code also
// uses the software prefetch instruction to pre-read the data. loop unrolling
align 16
