...
protected:
	...
	int start(uint16 nSocketPort = 0, int nSocketType = SOCK_STREAM);
	bool create(uint16 nSocketPort = 0, int nSocketType = SOCK_STREAM);

	virtual DWORD listeningImpl(LPVOID lpParam) = 0;
