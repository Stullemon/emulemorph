...
public:
	...
	*/
	...
	uint32  GetTotalActiveUploadsCountStat(uint32 classID = LAST_CLASS)     {uint32 retvalue = 0; for (uint32 i = 0; i <= classID; i++) retvalue+=m_MaxActiveClientsShortTimeClass[i]; return retvalue;} 
