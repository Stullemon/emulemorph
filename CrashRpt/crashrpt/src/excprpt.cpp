...
//		   RaiseException(EXCEPTION_BREAKPOINT, 0, 0, NULL);
		   /*
		    * When you were calling writeDumpFile without valid excpInfo
			* the debugger may have put you here.
			* Simply walk the stack some steps up.....
		    */
		   __asm {
			   int 3	// user breakpoint
		   }
	   } __except(writeDumpFile(hFile, GetExceptionInformation(), data), EXCEPTION_EXECUTE_HANDLER ) { //EXCEPTION_CONTINUE_EXECUTION) {
	   }
	} else {
