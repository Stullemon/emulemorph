...
public:
   ...
   TStrFileInfoVector  *m_pUDFiles;      // Files <name,desc>
   BOOL        m_sendButton;     // Display 'Send' or 'Save' button
	...
	BEGIN_MSG_MAP(CMainDlg)
      ...
      MESSAGE_HANDLER(WM_SYSCOMMAND, OnSysCommand)
		...
		COMMAND_ID_HANDLER(IDC_SAVE, OnSend)
   ...
   LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
	  ...
	  GetDlgItem(IDC_STATIC1).SetWindowText(
		  CUtility::GetResString(IDS_MAIN_STR1) + "\r\n\r\n" +
		  CUtility::GetResString(IDS_MAIN_STR2) + "\r\n\r\n" +
		  CUtility::GetResString(IDS_MAIN_STR3));
	  GetDlgItem(IDC_STATIC4).SetWindowText(CUtility::GetResString(IDS_MAIN_STR4));
	  GetDlgItem(IDC_EMAILLABEL).SetWindowText(CUtility::GetResString(IDS_EMAIL));
	  GetDlgItem(IDC_DESCRIPTIONLABEL).SetWindowText(CUtility::GetResString(IDS_DESCRIPTION));
	  GetDlgItem(IDC_LINK).SetWindowText(CUtility::GetResString(IDS_LINK));
